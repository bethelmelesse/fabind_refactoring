...
def get_arguments():
    ...
    parser.add_argument(
        "-m", "--mode", type=int, default=0, help="mode specify the model to use."
    )
    parser.add_argument(
        "-d",
        "--data",
    ...
    parser.add_argument(
        "--gs-tau", type=float, default=1, help="Tau for the temperature-based softmax."
    )
    parser.add_argument(
        "--gs-hard",
        action="store_true",
    ...
    parser.add_argument(
        "--label", type=str, default="", help="information you want to keep a record."
    )
    ...
    parser.add_argument(
        "--tqdm-interval", type=float, default=0.1, help="tqdm bar update interval"
    )
    ...
    parser.add_argument(
        "--pocket-cls-loss-func", type=str, default="bce", choices=["bce", "dice"]
    )
    ...
    parser.add_argument(
        "--distmap-pred", type=str, default="mlp", choices=["mlp", "trig"]
    )
    ...
    parser.add_argument(
        "--refine", type=str, default="refine_coord", choices=["stack", "refine_coord"]
    )
    ...
    parser.add_argument(
        "--rm-LAS-constrained-optim", action="store_true", default=False
    )
    ...
    parser.add_argument(
        "--sample-n", type=int, default=0, help="number of samples in one epoch."
    )
    ...
    parser.add_argument(
        "--ablation-no-attention-with-cross-attn", action="store_true", default=False
    )
    ...
    parser.add_argument(
        "--mixed-precision", type=str, default="no", choices=["no", "fp16"]
    )
    ...
    parser.add_argument(
        "--train-ligand-torsion-noise", action="store_true", default=False
    )
